...
const translations = {
  en: {
    ...
    browse_all_equipment: "Browse all equipment, view reviews and ratings",
    search_equipment_placeholder: "Search equipment name or brand...",
    filter: "Filter",
    sort_by_rating_high: "Highest Rated",
    sort_by_rating_low: "Lowest Rated",
    sort_by_reviews_most: "Most Reviews",
    sort_by_name: "By Name",
    sort_by_price_low: "Price: Low to High",
    sort_by_price_high: "Price: High to Low",
    all_brands: "All Brands",
    all_categories: "All Categories",
    found_equipment: "Found {count} equipment",
    displayed_equipment: "(showing {count})",
    ...
    all_equipment_loaded: "All equipment displayed",
    no_equipment_found: "No Equipment Found",
    adjust_search_conditions:
      "Try adjusting search conditions or filter options",
  ...
  zh: {
    ...
    browse_all_equipment: "浏览全部装备，查看评价和评分",
    search_equipment_placeholder: "搜索装备名称或品牌...",
    filter: "筛选",
    sort_by_rating_high: "评分从高到低",
    sort_by_rating_low: "评分从低到高",
    sort_by_reviews_most: "评论数最多",
    sort_by_name: "按名称排序",
    sort_by_price_low: "价格从低到高",
    sort_by_price_high: "价格从高到低",
    all_brands: "所有品牌",
    all_categories: "所有分类",
    found_equipment: "找到 {count} 件装备",
    displayed_equipment: "(已显示 {count} 件)",
    write_review: "写评论",
    details: "详情",
    view_details: "查看详情",
    satisfaction: "用户满意度",
    reviews_count: "{count} 评价",
    load_more_equipment: "加载更多装备...",
    all_equipment_loaded: "已显示全部装备",
    no_equipment_found: "未找到装备",
    adjust_search_conditions: "尝试调整搜索条件或筛选选项",
