...
const translations = {
  en: {
    ...
    strava_connect_desc: "Connect your Strava account and we'll sync your sports data and provide detailed analysis reports",
    ...
    strava_connected_desc: "Your Strava account has been successfully connected. We will regularly sync your sports data and provide detailed analysis reports.",
    strava_disconnect: "Disconnect",
    strava_disconnecting: "Disconnecting...",
    strava_visit: "Visit Strava",
    strava_disconnect_confirm: "Are you sure you want to disconnect from Strava? This will delete all synced sports data.",
    ...
    equipment_notes_placeholder: "Record purchase channel, price or other information...",
    equipment_save: "Save Equipment",
    equipment_saving: "Saving...",
    equipment_cancel: "Cancel",
    equipment_no_records: "No equipment records yet",
    equipment_no_records_desc: "Add your sports equipment to track usage and mileage",
    ...
    equipment_delete_confirm: "Are you sure you want to delete equipment \"{name}\"? This action cannot be undone.",
    ...
    submit_equipment_login_desc: "Please login to submit new equipment for review.",
    submit_equipment_success: "Submission Successful!",
    submit_equipment_success_desc: "Thank you for your contribution! We will review your equipment submission soon.",
    ...
    submit_equipment_description_placeholder: "Detailed description of the equipment features, purpose, etc...",
    submit_equipment_images: "Product Image URLs",
    submit_equipment_add_image: "Add Image",
    submit_equipment_reason: "Submission Reason",
    submit_equipment_reason_placeholder: "Please explain why you're submitting this equipment, e.g., couldn't find this product when adding equipment, it's a new release...",
    submit_equipment_guidelines: "Submission Guidelines:",
    submit_equipment_guideline_1: "Please ensure all information provided is accurate",
    submit_equipment_guideline_2: "We will review your submission within 1-3 business days",
    submit_equipment_guideline_3: "Once approved, the equipment will be added to the database for all users",
    submit_equipment_guideline_4: "If you have any questions, please contact the administrator",
  ...
  zh: {
    ...
    strava_connect_desc: "连接您的Strava账号，我们将为您同步运动数据并提供详细的分析报告",
    ...
    strava_connected_desc: "您的Strava账号已成功连接。我们将定期同步您的运动数据，为您提供详细的分析报告。",
    strava_disconnect: "断开连接",
    strava_disconnecting: "断开连接中...",
    strava_visit: "访问Strava",
    strava_disconnect_confirm: "确定要断开与Strava的连接吗？这将删除所有同步的运动数据。",
    ...
    submit_equipment_success_desc: "感谢您的贡献！我们会尽快审核您提交的装备信息。",
    ...
    submit_equipment_reason_placeholder: "请说明为什么要提交这个装备，例如：在添加装备时没有找到这款产品，它是最新发布的...",
    submit_equipment_guidelines: "提交须知：",
    submit_equipment_guideline_1: "请确保提供的信息准确无误",
    submit_equipment_guideline_2: "我们会在1-3个工作日内审核您的提交",
    submit_equipment_guideline_3: "审核通过后，装备将添加到数据库供所有用户使用",
