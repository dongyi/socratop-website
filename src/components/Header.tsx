      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4 lg:gap-8 min-w-0 flex-1">
            ...
            {/* Navigation Menu — hidden on home page */}
            {!isHomePage && (
          ...
          {/* Right side — auth hidden on home page, language toggle always visible */}
              ...
              isAuthenticated ? (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  >
                    ...
                    <span className="hidden 2xl:inline text-xs">{displayName}</span>
                  </Link>
                  <button
                    onClick={signOut}
